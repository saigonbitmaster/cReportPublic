...
import { Show, HtmlField, TextField, translate, FlexForm, SelectField, DateField, NumberField } from 'creport-lib';
      ...
      <Show {...rest} resource="postjobs">
        <FlexForm toolbar={false} style={{ flexGrow: 1 }} spacing={2}>
          <Grid middle container spacing={2}>
            ...
            <Grid middle item xs={12} sm={4}>
              <NumberField source="estimatedCost" />
            </Grid>
            <Grid middle item xs={12} sm={4}>
              <NumberField source="requiredAda" />
            </Grid>
